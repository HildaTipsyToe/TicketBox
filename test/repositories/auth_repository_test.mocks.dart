...
// in ticketbox/test/repositories/auth_repository_test.dart.
...
class MockAuthDataSource extends _i1.Mock implements _i3.AuthDataSource {
  ...
  @override
  _i4.Stream<_i2.User?> get authStatus =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<void> createUser(String? name, String? email, String? password) =>
      (super.noSuchMethod(
...
/// A class which mocks [TBSettings].
///
/// See the documentation for Mockito's code generation for more information.
class MockTBSettings extends _i1.Mock implements _i6.TBSettings {
  MockTBSettings() {
    _i1.throwOnMissingStub(this);
  }
